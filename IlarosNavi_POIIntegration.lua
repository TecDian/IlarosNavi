...
local function setQuestWaypoint(self)
    ...
    local uid = IlarosNavi:AddZWaypoint(c, z, x, y, title)
    return uid
end
...
function IlarosNavi:EnableDisablePOIIntegration()
    hookEnabled = IlarosNavi.profile.poi.enable
    modifier = IlarosNavi.profile.poi.modifier
    watchframeHookEnabled = IlarosNavi.profile.poi.setClosest
end
