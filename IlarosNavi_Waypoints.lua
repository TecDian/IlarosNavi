...
function IlarosNavi:SetWaypoint(c, z, x, y, callbacks, show_minimap, show_world)
	...
	if not point then
		...
		minimap.icon:SetTexture("Interface\\AddOns\\IlarosNavi\\Images\\GoldGreenDot")
		...
		minimap.arrow:SetTexture("Interface\\AddOns\\IlarosNavi\\Images\\MinimapArrow-Green")
		...
		worldmap.icon:SetTexture("Interface\\AddOns\\IlarosNavi\\Images\\GoldGreenDot")
