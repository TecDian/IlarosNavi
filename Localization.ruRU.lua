...
IlarosNaviLocals = {
	...
	["Are you sure you would like to remove ALL IlarosNavi waypoints?"] = "Вы уверены, что хотите удалить ВСЕ направления IlarosNavi'а?",
	...
	["Save profile for IlarosNavi waypoints"] = "Сохранить профиль направлений IlarosNavi",
	["Save this waypoint between sessions"] = "Сохранять это направление межде сессиями",
	["Saved profile for IlarosNavi options"] = "Сохранить профиль опций IlarosNavi",
	["Scale"] = "Масштаб",
	...
	["This setting changes the modifier used by IlarosNavi when right-clicking on the world map to create a waypoint"] = "Зажав указанную ниже кнопку и щёлкнув правой кнопкой мыши по карте, будет создано новое направление с координатами курсора",
	...
	["IlarosNavi Waypoint Arrow"] = "Стрелка направления IlarosNavi",
	["IlarosNavi can announce new waypoints to the default chat frame when they are added"] = "IlarosNavi может сообщать в окно чата о создании новых направлений",
	["IlarosNavi can display a tooltip containing information abouto waypoints, when they are moused over.  This setting toggles that functionality"] = "IlarosNavi может показывать всплывающие окошки, содержащие информацию о соответствующем направлении",
	["IlarosNavi can display multiple waypoint arrows on the minimap.  These options control the display of these waypoints"] = "IlarosNavi может показывать несколько стрелок направления на миникарте. С помощью этих опций, вы можете настроить эту функциональность",
	["IlarosNavi can display multiple waypoints on the world map.  These options control the display of these waypoints"] = "IlarosNavi может показывать несколько направлений на карте мира. С помощью этих опций, вы можете настроить эту функциональность",
	["IlarosNavi can hide waypoints in other zones, this setting toggles that functionality"] = "IlarosNavi может показывать направления, установленные в других локациях",
	["IlarosNavi provides an arrow that can be placed anywhere on the screen.  Similar to the arrow in \"Crazy Taxi\" it will point you towards your next waypoint"] = "IlarosNavi может отображать стрелку направления, размещаемую в любом месте на экране. Подобно стрелке из \"Crazy Taxi\", она покажет вам направление до следующей точки",
	["IlarosNavi provides you with a floating coordinate display that can be used to determine your current position.  These options can be used to enable or disable this display, or customize the block's display."] = "IlarosNavi может показывать плавающий блок координат, для отображения текущей позиции персонажа.",
	["IlarosNavi waypoint"] = "Направление IlarosNavi",
	["IlarosNavi's saved variables are organized so you can have shared options across all your characters, while having different sets of waypoints for each.  These options sections allow you to change the saved variable configurations so you can set up per-character options, or even share waypoints between characters"] = "IlarosNavi может сохранять настройки как в общей папке для всех персонажей, так и по-отдельности для каждого. Эти опции позволяют вам расшарить направления для всего аккаунта, или же привязать их к соответствующим персонажам",
	...
	["When a new waypoint is added, IlarosNavi can automatically set the new waypoint as the \"Crazy Arrow\" waypoint."] = "При добавлении нового направления, IlarosNavi будет автоматически передавать его в стрелку направлений",
	["World Map"] = "Карта мира",
	["Yes"] = "Да",
	["\"Arrival Distance\""] = "\"Растояние до прибытия\"",
	["|cffffff78/Navi <x> <y> [desc]|r - Adds a waypoint at x,y with descrtiption desc"] = "|cffffff78/Navi <x> <y> [desc]|r - добавить точку направления x,y в текущей локации с описанием [desc]",
	["|cffffff78/Navi <zone> <x> <y> [desc]|r - Adds a waypoint at x,y in zone with description desc"] = "|cffffff78/Navi <zone> <x> <y> [desc]|r - Добавить точку направления x,y в зоне <zone> и описанием [desc]",
	["|cffffff78/Navi reset <zone>|r - Resets all waypoints in zone"] = "|cffffff78/Navi reset <zone>|r - Сбросить все направления в зоне <zone>",
	["|cffffff78/Navi reset all|r - Resets all waypoints"] = "|cffffff78/Navi reset all|r - Сбросить все направления",
	["|cffffff78IlarosNavi |r/Navi |cffffff78Usage:|r"] = "|cffffff78Использование|r команды |cffffff78/Navi :|r",
	["|cffffff78IlarosNavi|r: Added '%s' (sent from %s) to zone %s"] = "|cffffff78IlarosNavi|r: Добавить '%s' (присланное от %s) в локацию %s",
}
